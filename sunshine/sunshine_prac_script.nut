...
::GetSpawnPositions <- function(point)
{
    switch (point)
    {
        case BLU_SECOND:
            return [
                Vector(-7950, 6545, 137), // plat
                Vector(-8105, 6575, 137),
                Vector(-8105, 6776, 137),
                Vector(-8165, 6988, 137),
                Vector(-8026, 6982, 137),
                Vector(-7680, 6826, 200) // on point
            ];
        case MID:
            // all on point
            return [
                Vector(-5656, 5191, 137),
                Vector(-5630, 5316, 137),
                Vector(-5361, 5362, 137),
                Vector(-5363, 5190, 137),
                Vector(-5936, 5135, 137),
                Vector(-5943, 5348, 137)
            ];
        case RED_SECOND:
            return [
                Vector(-3344, 3984, 137), // plat
                Vector(-3159, 3925, 137),
                Vector(-3188, 3717, 137),
                Vector(-3074, 3500, 137),
                Vector(-3245, 3500, 137),
                Vector(-3557, 3668, 200) // on point
            ];
